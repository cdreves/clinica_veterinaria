...
public class formulariopaciente extends javax.swing.JInternalFrame {
    ...
    public void cargar_datos(String valor) {
        ...
        if (z == 0) {
            sSQL = "SELECT numero_paciente,nombre, color, fecha_nacimiento, especie, raza, sexo, rut_cliente FROM paciente WHERE nombre='" + valor + "'";
        } else {
    ...
    private void initComponents() {
        ...
        txt_color.setRequestFocusEnabled(false);
        ...
        txt_nombre.setFocusCycleRoot(true);
        txt_nombre.setPreferredSize(new java.awt.Dimension(120, 20));
        txt_nombre.setRequestFocusEnabled(false);
        ...
        txt_fechanac.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
